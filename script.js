...
document.querySelectorAll('.service-card, .contact-item, .stat-item, .skill-item').forEach(el => {
    el.style.opacity = '0';
...
// Mode sombre (optionnel - à activer si souhaité)
...
// Décommenter la ligne suivante pour activer le bouton mode sombre
// addDarkModeToggle();
